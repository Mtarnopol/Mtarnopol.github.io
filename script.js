// Loads previous expenses: my API or Local data 
...
function renderExpenses() {
    ...
    filtered.forEach((exp, index) => {
        ...
        //This creates a list item for each expense with the expense and category, adds a delete button, and then displays it in your expense list.
